...
if __name__ == "__main__":
    check_cupy_device()
    cp.random.seed(42)
    run_experiment(MiniDenseNet, "MiniDenseNet", epochs=1)
    run_experiment(MiniDenseNet, "MiniDenseNet", test_only=True, resume_path="checkpoints/baseline_MiniDenseNet.npz")
    run_experiment(MiniDenseNet, "MiniDenseNet", epochs=1, resume_path="checkpoints/baseline_MiniDenseNet.npz")
